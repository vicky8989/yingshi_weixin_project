...
var jsonpMongoLocal = function( queryJson, callback ) {
	var url     = queryJson.url;
	var dbname  = queryJson.db || '';
	var coll    = queryJson.coll;
	var method  = queryJson.method; // insert | remove | update | find
		var query   = queryJson.query ? queryJson.query : {};

	var data    = queryJson.data ? queryJson.data: {};
	var options = queryJson.options ? queryJson.options: null; 
...
exports.analyse = jsonpMongoLocal;
